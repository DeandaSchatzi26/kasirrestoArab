...
?>
    ...
    <head>
        ...
        <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/dSchiz.png">
        <link rel="icon" type="image/png" href="../assets/img/dSchiz.png">
        <title>
            RESTORAN
        </title>
        <!--     Fonts and icons     -->
        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
            <div class="sidenav-header">
                ...
                <a class="navbar-brand m-0" href="index.php?page=beranda">
                    <img src="../assets/img/dfotome.jpg" class="navbar-brand-img h-100" alt="main_logo">
                    <span class="ms-1 font-weight-bold">RestoArab DSchiz </span>
                </a>
            </div>
